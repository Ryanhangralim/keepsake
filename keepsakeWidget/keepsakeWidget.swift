...
struct SimpleEntry: TimelineEntry {
	...
	private func getAlbumEmoji(for albumId: String?) -> String {
		guard let albumId = albumId,
			  let sharedDefaults = UserDefaults(suiteName: "group.com.keepsakeu"),
...
struct KipsekWidget: Widget {
	var body: some WidgetConfiguration {
		AppIntentConfiguration(kind: "group.com.keepsakeu", intent: ConfigurationAppIntent.self, provider: Provider()) { entry in
